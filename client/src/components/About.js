      ...
      <div className="snap-y">
        ...
        <div className="snap-center bg-zinc-900 flex flex-col-reverse lg:flex-row items-center justify-center h-screen">
            <div>
                ...
                <div className="text-white italic text-center pt-10 font-louisgeorge">Creators Sarah Kuny, Shannon Williams, and Hannah Willows</div>
            </div>
            <div className="w-[720px] text-center pt-10  text-white flex flex-col items-center justify-center">
                <h3 className="text-7xl font-louisgeorge ">Our Mission</h3>
                <p className="w-4/6 text-xl pb-10">
